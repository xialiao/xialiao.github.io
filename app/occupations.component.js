...
var d3 = require("d3");
var OccupationsComponent = (function () {
    function OccupationsComponent() {
        this.selectedJob = null;
    }
    OccupationsComponent.prototype.ngOnInit = function () {
        ...
        var tooltip = d3.select("body").append("div")
            ...
            .style("opacity", 0);
        // load data
        d3.tsv("data/occupations.tsv", function (error, data) {
    ...
    return OccupationsComponent;
}());
OccupationsComponent = __decorate([
    core_1.Component({
...
exports.OccupationsComponent = OccupationsComponent;
//# sourceMappingURL=occupations.component.js.map