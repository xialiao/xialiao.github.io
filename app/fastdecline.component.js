...
var d3 = require("d3");
var FastDeclineComponent = (function () {
    function FastDeclineComponent() {
    }
    FastDeclineComponent.prototype.ngOnInit = function () {
        ...
        var tooltip = d3.select("body").append("div")
            ...
            .style("opacity", 0);
        // load data
        d3.tsv("data/fastdecline.tsv", function (error, data) {
    ...
    return FastDeclineComponent;
}());
FastDeclineComponent = __decorate([
    core_1.Component({
...
exports.FastDeclineComponent = FastDeclineComponent;
//# sourceMappingURL=fastdecline.component.js.map