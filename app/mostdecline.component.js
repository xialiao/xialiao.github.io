...
var MostDeclineComponent = (function () {
    ...
    MostDeclineComponent.prototype.ngOnInit = function () {
        ...
        var svg = d3.select("#md-plot").append("svg")
        ...
        var tooltip = d3.select("body").append("div")
            ...
            .style("opacity", 0);
        // load data
        d3.tsv("data/mostdecline.tsv", function (error, data) {
            ...
            .attr("stroke", "#1E384E")
            .attr("marker-end", "url(#md-triangle)");*/
            //line              
            svg.append("line")
                .attr("x1", 250)
                .attr("y1", 55)
            ...
            function displayJobDetails(data) {
                d3.select("#md-detail").selectAll("svg").remove();
                var svg = d3.select("#md-detail").append("svg");
            ...
            function drawBarChart(data) {
                d3.select("#md-bchart").selectAll("svg").remove();
                var svg = d3.select("#md-bchart").append("svg");
    ...
    return MostDeclineComponent;
}());
MostDeclineComponent = __decorate([
    core_1.Component({
        selector: 'mostdecline',
        templateUrl: './mostdecline.component.html',
        styleUrls: ['./mostdecline.component.css']
    }),
    __metadata("design:paramtypes", [])
], MostDeclineComponent);
exports.MostDeclineComponent = MostDeclineComponent;
//# sourceMappingURL=mostdecline.component.js.map