...
var d3 = require("d3");
var FastGrowComponent = (function () {
    function FastGrowComponent() {
    }
    FastGrowComponent.prototype.ngOnInit = function () {
        ...
        var svg = d3.select("#fg-plot").append("svg")
        ...
        var tooltip = d3.select("body").append("div")
            ...
            .style("opacity", 0);
        // load data
        d3.tsv("data/fastgrow.tsv", function (error, data) {
            ...
            svg.append("line")
                ...
                .attr("stroke", "#1E384E")
                .attr("marker-end", "url(#fg-triangle)");
            svg.append("text")
                .attr("x", 200)
                .attr("y", 300)
                ...
                .text("Majority of fastest growing jobs require some level of postsecondary education");
            // draw dots
            svg.selectAll(".dot")
                .data(data)
                .enter().append("circle")
            ...
            function displayJobDetails(data) {
                d3.select("#fg-detail").selectAll("svg").remove();
                var svg = d3.select("#fg-detail").append("svg");
            ...
            function drawBarChart(data) {
                d3.select("#fg-bchart").selectAll("svg").remove();
                var svg = d3.select("#fg-bchart").append("svg");
    ...
    return FastGrowComponent;
}());
FastGrowComponent = __decorate([
    core_1.Component({
        selector: 'fastgrow',
        templateUrl: './fastgrow.component.html',
        styleUrls: ['./fastgrow.component.css']
    }),
    __metadata("design:paramtypes", [])
], FastGrowComponent);
exports.FastGrowComponent = FastGrowComponent;
//# sourceMappingURL=fastgrow.component.js.map